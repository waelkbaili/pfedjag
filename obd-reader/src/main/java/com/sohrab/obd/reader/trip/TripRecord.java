...
public class TripRecord implements DefineObdReader {
    ...
    private final static String PIDS_01_20="Available PIDs 01-20";
    private final static String PIDS_21_40="Available PIDs 21-40";
    private final static String PIDS_41_60="Available PIDs 41-60";
    ...
    private String mPID1_20;
    private String mPID21_40;
    private String mPID41_60;
    ...
    public void updateTrip(String name, ObdCommand command) {
        ...
        switch (name) {
            ...
            case PIDS_01_20:
                mPID1_20=command.getFormattedResult();
                break;

            case PIDS_21_40:
                mPID21_40=command.getFormattedResult();
                break;

            case PIDS_41_60:
                mPID41_60=command.getFormattedResult();
                break;
        }
    ...
    public String getmPID1_20(){
        return mPID1_20;
    }

    public String getmPID21_40(){
        return mPID21_40;
    }

    public String getmPID41_60(){
        return mPID41_60;
    }
   ...
   private ArrayList<ObdCommand> mObdCommandArrayList;
    ...
    public String toString() {
        return "OBD data ::" +
                ...
                "\n" + AvailableCommandNames.PIDS_01_20.getValue() + ":  " + mPID1_20+
                "\n" + AvailableCommandNames.PIDS_21_40.getValue() + ":  " + mPID21_40+
                "\n" + AvailableCommandNames.PIDS_41_60.getValue() + ":  " + mPID41_60+

                "\n"+AvailableCommandNames.VIN.getValue()+": "+mVehicleIdentificationNumber;
